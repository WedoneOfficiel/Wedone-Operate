...
<p align="center">
  <img src="https://raw.githubusercontent.com/WedoneOfficiel/Wedone-Operate/main/icon.png" />
</p>
...
Logiciel actuellement disponible uniquement pour les ordinateurs équipés de Microsoft Windows (x86_64 ET x86 pour les versions antérieures à la version 3.0).

Nous vous certifions que ce logiciel est compatible avec ces versions de Microsoft Windows : 10 / 11. Les versions non citées ci-avant peuvent s'avérer compatibles avec le présent logiciel mais notre équipe ne l'a actuellement pas vérifié.

Nous vous recommandons donc d'utiliser une des éditions citées précédemment pour un rendu de qualité.

 
# Dernière version
Stable version 3.5 - télécharger à cette page : https://github.com/WedoneOfficiel/Wedone-Operate/releases/tag/Stable-v3.5
...
Plus d'informationsdans le [blog](https://github.com/WedoneOfficiel/Wedone-Operate/blob/main/README.md#la-version-30-est-arriv%C3%A9e-)
